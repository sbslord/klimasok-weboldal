  ...
  <header class="bg-white/80 backdrop-blur sticky top-0 z-30 shadow-sm">
    <div class="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
      <a href="#" class="flex items-center gap-3">
        ...
        <span class="font-semibold">Klimás</span>
      </a>

      <nav class="hidden md:flex gap-6 items-center text-sm">
        <a href="#features" class="hover:text-primary">Szolgáltatások</a>
        <a href="#products" class="hover:text-primary">Termékek</a>
        <a href="#about" class="hover:text-primary">Rólunk</a>
        <a href="#contact" class="text-white bg-primary px-4 py-2 rounded-lg shadow hover:opacity-95">Kapcsolat</a>
      </nav>
